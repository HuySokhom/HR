<?php
  ...
  define('HTTP_COOKIE_PATH', '/HR/');
  define('HTTPS_COOKIE_PATH', '/HR/');
  define('DIR_WS_HTTP_CATALOG', '/HR/');
  define('DIR_WS_HTTPS_CATALOG', '/HR/');
  ...
  define('DIR_FS_CATALOG', '/var/www/HR/');
